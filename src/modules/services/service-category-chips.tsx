...
import { SERVICE_CATEGORIES, SERVICE_CATEGORY_LABEL, serviceCategoryAccent } from './service-category';
...
interface ServiceCategoryChipsProps {
  readonly active: ServiceCategoryFilter;
  readonly onSelect: (category: ServiceCategoryFilter) => void;
}
    ...
    >
      ...
      {SERVICE_CATEGORIES.map((category) => (
        <CategoryChip
          ...
          treatment={CATEGORY_CHIP_ACTIVE_TREATMENT[serviceCategoryAccent(category)]}
        />
      ))}
    </ScrollView>
  );
