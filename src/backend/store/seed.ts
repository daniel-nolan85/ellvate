...
const seedBusinessListings = (): readonly StoredBusinessListing[] => [
  {
    ...
    currentSpecials: [
      ...
      'Live music every Friday night, no cover.',
    ],
    specialsUpdatedAt: isoHoursBeforeSeedNow(30),
  ...
  },
  {
    ...
    currentSpecials: ['10% off any rental booked this week.'],
    specialsUpdatedAt: isoHoursBeforeSeedNow(60),
    verificationStatus: 'verified',
