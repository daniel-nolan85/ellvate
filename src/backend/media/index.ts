...
// upload -- reads `raw.checkInPhoto` rather than the array field the
// gallery uploads use. Missing or malformed shape means "no photo
// attached", which is a perfectly valid check-in (the photo is optional);
// a well-formed data URL that violates a limit still rejects the request.
