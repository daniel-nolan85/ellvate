  ...
  return (
    ...
    >
      <LegalSection id="overview" title="Overview">
        <p>
          {BRAND.appName} is a community app for {BRAND.community}, built and
          operated by {BRAND.companyLegalName} (&ldquo;we,&rdquo;
          &ldquo;us,&rdquo; or &ldquo;our&rdquo;). This policy explains what
          information we collect when you use the app, how we use it, who we
          share it with, and the choices you have.
        </p>
        <p>
          We built {BRAND.appName} to run a small residential community, not to
          build a profile on you for advertising. We don&rsquo;t sell your
          information, and we don&rsquo;t show you third-party ads.
        </p>
      </LegalSection>
      ...
      <LegalSection id="information-we-collect" title="Information we collect">
        ...
        <p>
          We do not collect your precise location, and we do not use advertising
          trackers or third-party analytics SDKs.
        </p>
      </LegalSection>
      ...
      <LegalSection id="sharing" title="Who we share it with">
        <p>
          We use a small number of service providers to run {BRAND.appName}.
          Each only receives the information it needs to do its job, and none
          are permitted to use your information for their own purposes:
        </p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
        ...
        <p>
          We will also disclose information if required by law, or to protect
          the rights, property, or safety of {BRAND.appName}, our members, or
          the public.
        </p>
      ...
      <LegalSection id="your-choices" title="Your choices and rights">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            ...
            in, such as an event people have joined, stays up for the community
      ...
      <LegalSection id="retention" title="How long we keep your information">
        <p>
          ...
          account is active. If you delete your account, we permanently delete
          your profile and content within a reasonable period, except where a
          copy is kept for a short time in backups or where content you created
          remains genuinely useful to the community (see Account deletion
          above).
        </p>
      </LegalSection>
      ...
      <LegalSection id="children" title="Children's privacy">
        <p>
          {BRAND.appName} is not directed at children, and we don&rsquo;t
      ...
      <LegalSection id="changes" title="Changes to this policy">
        <p>
          We may update this policy as {BRAND.appName} changes. If we make a
      ...
      <LegalSection id="contact" title="Contact us">
        <p>
          ...
          Contact Us page in the {BRAND.appName} app, or write to{' '}
